...
class AlertsControllerTest < ActionController::TestCase
  ...
  test "should create alert" do
    assert_difference('Alert.count') do
      post :create, alert: { percentage_difference: @alert.percentage_difference, price_range: @alert.price_range }
    end
  ...
  test "should update alert" do
    patch :update, id: @alert, alert: { percentage_difference: @alert.percentage_difference, price_range: @alert.price_range }
    assert_redirected_to alert_path(assigns(:alert))
  end
